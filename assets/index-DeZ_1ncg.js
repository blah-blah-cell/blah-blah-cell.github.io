 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const G3=o=>{for(const e in o)if(e.startsWith("aria-")||e==="role"||e==="title")return!0;return!1},V3=ln.createContext({}),X3=()=>ln.useContext(V3),k3=ln.forwardRef(({color:o,size:e,width:i,height:s,strokeWidth:c,absoluteStrokeWidth:f,nonScalingStroke:d,className:h="",children:m,iconNode:p=[],icon:x={node:p,aliases:[],size:24},...v},_)=>{const{size:E=24,strokeWidth:T=2,absoluteStrokeWidth:w=!1,nonScalingStroke:y=!1,color:S="currentColor",className:N=""}=X3()??{},B=!!m||G3(v),[C,U,D=[]]=H3(x,{color:o??S,width:i??e??E,height:s??e??E,strokeWidth:c??T,absoluteStrokeWidth:f??w,nonScalingStroke:d??y,className:Xp(N,h),hasA11yProp:B,attributes:v});return ln.createElement(C,{ref:_,...U},[...D.map(([P,b])=>ln.createElement(P,b)),...Array.isArray(m)?m:[m]])});/**
 * @license lucide-react v1.45.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */function Pa(o,e=[],i=[]){const s=typeof o=="string"?I3(o,e,i):o,c=ln.forwardRef(({className:f,...d},h)=>ln.createElement(k3,{ref:h,icon:s,className:f,...d}));return s.name&&(c.displayName=B3(s.name)),c}/**
 * @license lucide-react v1.45.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
def parse_authenticode_dir(pe_bytes: bytes) -> dict:
    ...
    }`},{name:"argus_gating_kernel.rs",lang:"Rust / Edge Defense",desc:"Senti_Argus sub-3ms Mixture-of-Experts packet evaluation engine",code:`pub struct MoERouter {
    threshold: f32,
